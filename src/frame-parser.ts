...
const parseNodeIdentificationPayload = function (frame, reader: BufferReader): void {
...
const ParseIOSamplePayload = function (frame, reader: BufferReader, options): void {
...
export type ParsableFrame = Parameters<typeof frameParser[keyof typeof frameParser]>[0]
